module.exports = {
    ...
    createGamer: 'INSERT INTO "gamer" (name, userName, phoneNumber, email, password) VALUES ($1, $2, $3, $4, $5) RETURNING *',

    deleteGamer: 'DELETE FROM "gamer" WHERE "id" = $1',

    updateGamer: 'UPDATE "gamer" SET name = $1, userName = $2, phoneNumber = $3, email = $4, password = %5 WHERE id = $6 RETURNING *',
