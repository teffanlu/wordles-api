...
ALTER TABLE "word" ADD FOREIGN KEY ("gamer_id") REFERENCES "gamer" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
  ...
  ALTER TABLE IF EXISTS "gamer" ALTER COLUMN "totalPoints" SET DEFAULT 0;
  ALTER TABLE IF EXISTS "gamer" ALTER COLUMN "currentStreak" SET DEFAULT 0;
  ALTER TABLE IF EXISTS "gamer" ALTER COLUMN "winStreak" SET DEFAULT 0;